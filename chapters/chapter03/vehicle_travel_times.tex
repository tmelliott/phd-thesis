...
\subfloat[The simulated data.\label{fig:sim1_graph1}]{\includegraphics[width=.49\linewidth]{figure/sim1_graph-1} }
\subfloat[10~s sampling.\label{fig:sim1_graph2}]{\includegraphics[width=.49\linewidth]{figure/sim1_graph-2} }\newline
\subfloat[30~s sampling.\label{fig:sim1_graph3}]{\includegraphics[width=.49\linewidth]{figure/sim1_graph-3} }
\subfloat[Observations at bus stops and intersections.\label{fig:sim1_graph4}]{\includegraphics[width=.49\linewidth]{figure/sim1_graph-4} }\caption[Simulated vehicle trajectory, with five road segments]{Simulated vehicle trajectory, with five road segments.}\label{fig:sim1_graph}
\end{figure}
