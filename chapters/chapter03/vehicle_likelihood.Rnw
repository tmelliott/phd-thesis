...
First, note that the distance is simply the magnitude of the error $\vec{r}\vi_k$,
\begin{equation*}
...
<<pf_wts,echo=FALSE,message=FALSE,cache=TRUE,fig.width=8,fig.height=3,fig.align="center",fig.cap="Goobie.">>=
