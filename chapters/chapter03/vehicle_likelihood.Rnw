...
p(\Vobs_k | \Vstate\vi_k) =
    \frac{1}{2} \exp\left\{
        - \frac{\GPSerr\dist{\Vobs_k, \Vmeas(\Vstate\vi_k)}^2}{2}
    \right\}
\end{equation}
...
can cause issues with the \pf{} when
