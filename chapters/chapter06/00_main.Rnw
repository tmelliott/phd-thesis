...
<<eta_cdf,echo=FALSE,fig.width=8*.6,fig.height=2.5,out.width=".6\\textwidth",fig.cap="CDF of arrival time after rounding particle estimates down to the nearest minute.",fig.align="center">>=
