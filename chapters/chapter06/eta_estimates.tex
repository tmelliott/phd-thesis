...
\end{equation}
\Cref{fig:eta_calc_quantile} shows a single \gls{cdf} with a horizontal line at $q = 0.5$, where the solution to \cref{eq:eta_calc_quantile} is the maximum values below this line (the red points) which is, in this case, $\hat\Teta_{0.5} = 11$.
