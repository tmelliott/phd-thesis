...
knitr::kable(
  ...
  format = "latex",
  booktabs = TRUE,
  caption = "GTFS prediction results over all journeys, with the displayed values representing the proportion of outcomes in each cell (rows are conditioned by the GTFS prediction of Yes of No. ",
  escape = FALSE,
  linesep = ""
) %>%
  kableExtra::add_header_above(
