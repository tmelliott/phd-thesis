...
<<eta_overall_results,echo=FALSE,cache=TRUE,dependson="eta_load",fig.width=8*.7,fig.height=5,out.width=".7\\textwidth",fig.align="center",fig.cap="Comparison of summary statistics for various quantiles of the predictive distribution, and the currently deployed GTFS method. Results are displayed for all day average, and off-peak (between 9h30 and 14h30).">>=
