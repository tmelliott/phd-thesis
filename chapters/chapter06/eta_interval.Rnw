...
p1 <- ggplot(d, aes(p, 100 * cov)) +
  ...
  geom_path(aes(y = 100 * cov_offpeak, colour = "Off-peak only")) +
...
p2 <- ggplot(d, aes(100 * alpha / 2, 100 * pbefore)) +
  geom_path(aes(colour = "All day")) +
  geom_path(aes(y = 100 * pbefore_offpeak, colour = "Off-peak only")) +
...
p3 <- ggplot(d, aes(p, len)) +
  geom_path(aes(colour = "All day")) +
  geom_path(aes(y = len_offpeak, colour = "Off-peak only")) +
