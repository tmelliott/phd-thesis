...
<<eta_calc_quantile,echo=FALSE,fig.width=6,fig.height=3,out.width=".8\\textwidth",fig.cap="Quantile estimation from a CDF. ETA values with quantiles below the desired threshold are coloured red; the maximum of these is the quantile value.",fig.align="center">>=
