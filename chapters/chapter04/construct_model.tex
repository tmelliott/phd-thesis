...
{\centering \subfloat[Underlying average speed along segment\label{fig:nw_sim_data1}]{\includegraphics[width=0.8\textwidth]{figure/nw_sim_data-1} }\\
\subfloat[Average speeds of individual buses\label{fig:nw_sim_data2}]{\includegraphics[width=0.8\textwidth]{figure/nw_sim_data-2} }\\
\subfloat[Observed average speeds of buses, with vertial lines to denote measurement error.\label{fig:nw_sim_data3}]{\includegraphics[width=0.8\textwidth]{figure/nw_sim_data-3} }\\
