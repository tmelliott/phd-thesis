...
estimation of the betas was not as important,
as we do not expect these to be constant throughout the day.
The point here was to estimate the parameters of change.
