...
<<tt_week0_load,cache=TRUE,echo=FALSE,fig.height=8,fig.width=8,fig.align="center",out.width="\\textwidth",fig.cap="Travel times along six roads over one week, coloured by the day of the week.">>=
library(ggplot2)
