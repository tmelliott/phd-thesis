...
<<tt_future_day,echo=FALSE,fig.height=2,fig.width=6,fig.align="center",out.width=".8\\linewidth",fig.cap="Travel times along a road one week in the future.">>=
library(ggplot2)
source("load_nw_data.R")
tt_future %>% filter(segment_id == sids[[1]])
