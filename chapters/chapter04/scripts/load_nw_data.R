...
tt_all <- data_from_file("data/all_tt.rda", con)

if (!dir.exists("data/future_archive"))
    unzip("../../data/archive_2019-08-20.zip", exdir = "data/future_archive")
tt_future <- data_from_file("data/future_tt.rda", con, "data/future_archive")
