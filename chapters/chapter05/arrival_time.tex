...
There are various ways to forecast arrival times, each with associated drawbacks and advantages. In this section, we present four arrival time prediction methods:
\begin{itemize}
