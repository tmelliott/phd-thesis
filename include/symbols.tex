...
\newcommand{\Vmeas}{h}
\newcommand{\Vprojf}{g}
\newcommand{\Vproj}[2]{g\left(#1\cond{}#2\right)}
\newcommand{\Viproj}[2]{g^{-1}\left(#1\cond{}#2\right)}
\newcommand{\VnoiseSD}{\sigma}
\newcommand{\Vnoise}{\VnoiseSD^2}
...
\multicolumn{3}{l}{Statistical distributions} \\
\hline

$\Bern{\pi}$ &
\multicolumn{2}{l}{Bernoulli distribution with probability of success $\pi$} \\

$\Exp{\lambda}$ &
\multicolumn{2}{l}{Exponential distribution with rate $\lambda$} \\

$\GammaD{r}{\theta}$ &
\multicolumn{2}{l}{Gamma distribution with shape $r$ and scale $\theta$} \\

$\Normal{\mu}{\sigma^2}$ &
\multicolumn{2}{l}{Normal distribution with mean $\mu$ and variance $\sigma^2$} \\
$\TNormal{\mu}{\sigma^2}{a}{b}$ &
\multicolumn{2}{l}{Truncated Normal distribution with mean $\mu$ and variance $\sigma^2$ }\\
& truncated to the interval $(a,b)$  \\

$\Uniform{a}{b}$ &
\multicolumn{2}{l}{Uniform distribution on the interval $(a,b)$} \\
