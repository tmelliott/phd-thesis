...
\usepackage[acronym,nonumberlist,toc]{glossaries} %Load glossaries package
\makeglossaries
...
\Sexpr{knit_child('chapters/chapter01/00_main.Rnw')}
\Sexpr{knit_child('chapters/chapter02/00_main.Rnw')}
\Sexpr{knit_child('chapters/chapter03/00_main.Rnw')}
\Sexpr{knit_child('chapters/chapter04/00_main.Rnw')}
\Sexpr{knit_child('chapters/chapter05/00_main.Rnw')}
\Sexpr{knit_child('chapters/chapter06/00_main.Rnw')}
\Sexpr{knit_child('chapters/chapter07/00_main.Rnw')}
