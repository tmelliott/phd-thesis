...
%% override the `ifglsused` command used by glossaries-prefix to determine if an abbr has been using /in this chapter/ (via `glsentrycurrcount`)
\newcommand{\agls}[1]%
    {%
...
%%%%%%%%%%% THIS HIDES UNREFERRENCED EQUATIONS ...
\usepackage{autonum}
